...
class DoLa:
    ...
    def load_model(self, model_name):
        ...
        # if "TheBloke/Llama-2-7B-Chat-GGML" == model_name:
        #     kwargs['revision'] = "ggmlv3.q6_K.bin"
    ...
    def lm_score(self, input_text1, input_text2, pmi=False, max_new_tokens=256, top_p=0.95, top_k=0, temperature=0.8,
                 mature_layer=None, premature_layer=None, candidate_premature_layers=[], mode='baseline', verbose=True,
                 remove_stop_words=False, relative_top=0.1, relative_top_value=-1000.0, post_softmax=True, **kwargs):
        with torch.no_grad():
